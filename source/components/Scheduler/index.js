...
const mapStateToProps = (state) => {
    return {
        ...
        allCompleted: state.todos.every(
            (item) => item.get("completed") === true
        ),
    };
};
...
export default class Scheduler extends Component {
    ...
    _allCompletedTodos = () => {
        ...
        this.props.actions.allCompletedTodosAsync(
            todos
                .map((item) => item.update("completed", (value) => true).toJS())
                .toArray()
        );
    };
